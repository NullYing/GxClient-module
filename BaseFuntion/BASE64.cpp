...
bool CBase64::Encode(const unsigned char *pIn, unsigned long uInLen, CStringA& strOut)
{
	unsigned long i, len2, leven;
	strOut = "";
...
bool CBase64::Decode(const CStringA& strIn, unsigned char *pOut, unsigned long *uOutLen)
{
...
CStringA CBase64::Encode(CStringA data)
{
	CStringA s;
...
CStringA CBase64::Decode(CStringA data)
{
	CStringA s;
...
int CBase64::GetDecodeBufferLength(CStringA data)
{
	int len = 0;
